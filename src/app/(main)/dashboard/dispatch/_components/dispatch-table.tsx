...
import type { DispatchOrderRow } from "./types";
...
export function DispatchTable({ table }: { table: TableType<DispatchOrderRow> }) {
        ...
        <Table className="**:data-[slot='table-cell']:px-4 **:data-[slot='table-head']:px-4">
          <TableHeader className="[&_tr]:border-t">
            {table.getHeaderGroups().map((hg) => (
              <TableRow key={hg.id}>
                {hg.headers.map((h) => (
                  <TableHead key={h.id} className="py-4 font-normal">
